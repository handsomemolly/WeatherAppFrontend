    ...
    return (
      <Router>
        <div className="App">
          ...
          <Route path="/Welcome" render={() => {return <UserContainer getUser={this.getUser}/>}}/>
          <Route exact path="/Edit" render={() => {return <EditAccount userInfo={this.state.user} handleLogout={this.handleLogout}/>}}/>
          </Switch>
